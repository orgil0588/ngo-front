    ...
    <div className="mt-12">
      <div className="flex flex-col justify-between items-center lg:flex-row lg:justify-between">
        <div className=" w-full text-center lg:text-left xl:w-8/12 2xl:w-10/12">
          <h1 className="text-3xl font-bold leading-none text-primary-dark mb-4 lg:text-4xl xl:text-5xl 2xl:text-6xl">
            Иргэдийн{" "}
            <span className="text-primary-blue">санхүүгийн хүртээмжийг</span>{" "}
            нэмэгдүүлэхийн төлөө
          </h1>
          <p className="text-primary-gray leading-relaxed font-medium xl:w-8/12">
